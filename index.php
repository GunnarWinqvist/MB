...
switch($nextPage) {	
    ...
    case 'create_page': require_once(TP_PAGESPATH . 'PCreatePage.php');         break;
    case 'save_page':   require_once(TP_PAGESPATH . 'PSavePage.php');           break;
...
//    case 'new_passw2':  require_once(TP_PAGESPATH . 'admin/PNewPassw2.php');    break;
    ...
    case 'del_user':    require_once(TP_PAGESPATH . 'admin/PDelUser.php');      break;
